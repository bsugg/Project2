...
For the analysis of articles published on **Tuesday** there are a total
of 7,288 records sliced as:

  - 5,101 records used in the `newsTrain` data set (69.99%)  
  - 2,187 records used in the `newsTest` data set (30.01%)
...
| ------- | ---------------: | -----------------: | ---------------: | ---------------: |
| Min.    |              4.0 |                0.0 |              0.0 |              0.0 |
| 1st Qu. |              9.0 |              251.0 |              1.0 |              0.0 |
| Median  |             10.0 |              407.0 |              1.0 |              0.0 |
| Mean    |             10.4 |              545.9 |              4.4 |              1.3 |
| 3rd Qu. |             12.0 |              704.0 |              4.0 |              1.0 |
| Max.    |             19.0 |             7002.0 |            100.0 |             59.0 |
...
![](Tuesday_files/figure-gfm/histogram-1.png)<!-- -->
...
![](Tuesday_files/figure-gfm/boxPlot-1.png)<!-- -->
...
![](Tuesday_files/figure-gfm/scatterPlots-1.png)<!-- -->
...
![](Tuesday_files/figure-gfm/bar100-1.png)<!-- -->
...
```
    ...
    ## Summary of sample sizes: 3826, 3826, 3826, 3825, 3827, 3826, ... 
    ## Resampling results across tuning parameters:
    ## 
    ##   mtry  Accuracy   Kappa    
    ##    2    0.6532693  0.3064519
    ##    7    0.6488911  0.2976410
    ##   12    0.6475204  0.2948077
    ##   18    0.6483714  0.2964736
    ##   23    0.6479786  0.2956960
    ##   28    0.6469326  0.2936101
    ##   34    0.6441883  0.2881676
    ##   39    0.6432735  0.2863030
    ##   44    0.6440571  0.2879760
    ##   50    0.6424227  0.2846210
    ## 
...
```
    ...
    ## Summary of sample sizes: 4591, 4592, 4590, 4591, 4591, 4591, ... 
    ## Resampling results:
    ## 
    ##   Accuracy  Kappa    
    ##   0.640505  0.2804252
...
published on a **Tuesday** is done using **Ensemble Model with Random
Forests**. This is based on having a higher **accuracy value of 0.6388**
with an associated **misclassification rate of 0.3612**.
