...
For the analysis of articles published on **Wednesday** there are a
total of 7,330 records sliced as:

  - 5,131 records used in the `newsTrain` data set (70%)  
  - 2,199 records used in the `newsTest` data set (30%)
...
| ------- | ---------------: | -----------------: | ---------------: | ---------------: |
| Min.    |              4.0 |                  0 |                0 |              0.0 |
| 1st Qu. |              9.0 |                247 |                1 |              0.0 |
| Median  |             10.0 |                402 |                1 |              0.0 |
| Mean    |             10.4 |                529 |                4 |              1.2 |
| 3rd Qu. |             12.0 |                697 |                3 |              1.0 |
| Max.    |             18.0 |               4747 |               92 |             73.0 |
...
![](Wednesday_files/figure-gfm/histogram-1.png)<!-- -->
...
```
    ...
    ## Summary of sample sizes: 4618, 4618, 4617, 4619, 4617, 4618, ... 
    ## Resampling results:
    ## 
    ##   Accuracy   Kappa    
    ##   0.6438851  0.2860062
...
```
    ...
    ##                  95% CI : (0.5964, 0.6375)
    ##     No Information Rate : 0.5357          
    ##     P-Value [Acc > NIR] : 8.015e-15       
    ##                                           
    ##                   Kappa : 0.2292          
    ##                                           
    ##  Mcnemar's Test P-Value : 0.4692          
    ##                                           
    ##             Sensitivity : 0.6520          
    ##             Specificity : 0.5769          
