...
```
    ...
    ## Summary of sample sizes: 842, 844, 843, 843, 842, 844, ... 
    ## Resampling results across tuning parameters:
    ## 
    ##   mtry  Accuracy   Kappa    
    ##    2    0.7714512  0.1773193
    ##    7    0.7716468  0.2006050
    ##   12    0.7696702  0.2024162
    ##   18    0.7696716  0.2090675
    ##   23    0.7686802  0.2123676
    ##   28    0.7672984  0.2059259
    ##   34    0.7680878  0.2160046
    ##   39    0.7665064  0.2101259
    ##   44    0.7667048  0.2136671
    ##   50    0.7661091  0.2113684
    ## 
...
`MTRY` value of **7**. This model fit will be tested on `newsTest` data
...
```
    ...
    ##          Neg Pred Value : 0.75380         
    ##              Prevalence : 0.28216         
    ##          Detection Rate : 0.05809         
    ##    Detection Prevalence : 0.08990         
    ##       Balanced Accuracy : 0.58078         
    ##                                           
    ##        'Positive' Class : 0               
    ## 
...
`newsTest` with **`MTRY=`7**:  
**Accuracy:** 0.7441  
**Misclassification Rate:** 0.2559
...
**Random Forest** model predictions on `newsTest` with **`MTRY=`7**:  
**Accuracy:** 0.7441  
**Misclassification Rate:** 0.2559
...
published on a **Saturday** is done using **the Ensemble Model with
Random Forests**. This is based on having a higher **accuracy value of
0.7441** with an associated **misclassification rate of 0.2559**.
