...
For the analysis of articles published on **Saturday** there are a total
of 2,409 records sliced as:

  - 1,686 records used in the `newsTrain` data set (69.99%)  
  - 723 records used in the `newsTest` data set (30.01%)
...
| ------- | ---------------: | -----------------: | ---------------: | ---------------: |
| Min.    |              5.0 |                0.0 |              0.0 |              0.0 |
| 1st Qu. |              9.0 |              275.2 |              1.0 |              0.0 |
| Median  |             10.0 |              503.5 |              1.0 |              0.0 |
| Mean    |             10.3 |              609.0 |              5.4 |              1.2 |
| 3rd Qu. |             12.0 |              788.8 |              8.0 |              1.0 |
| Max.    |             18.0 |             7034.0 |            101.0 |             74.0 |
...
![](Saturday_files/figure-gfm/histogram-1.png)<!-- -->
...
![](Saturday_files/figure-gfm/boxPlot-1.png)<!-- -->
...
![](Saturday_files/figure-gfm/bar100-1.png)<!-- -->
...
```
    ...
    ## Summary of sample sizes: 1265, 1265, 1263, 1265, 1264, 1265, ... 
    ## Resampling results across tuning parameters:
    ## 
    ##   mtry  Accuracy   Kappa    
    ##    2    0.7682951  0.1684073
    ##    7    0.7686877  0.1916188
    ##   12    0.7714574  0.2059193
    ##   18    0.7690812  0.2098980
    ##   23    0.7690826  0.2077548
    ##   28    0.7710550  0.2147538
    ##   34    0.7694733  0.2157580
    ##   39    0.7682932  0.2093747
    ##   44    0.7674986  0.2088313
    ##   50    0.7720433  0.2271235
    ## 
...
`MTRY` value of **50**. This model fit will be tested on `newsTest` data
...
```
    ...
    ##             Sensitivity : 0.23039         
    ##             Specificity : 0.94220         
    ##          Pos Pred Value : 0.61039         
    ##          Neg Pred Value : 0.75697         
    ##              Prevalence : 0.28216         
    ##          Detection Rate : 0.06501         
    ##    Detection Prevalence : 0.10650         
    ##       Balanced Accuracy : 0.58629         
    ##                                           
    ##        'Positive' Class : 0               
    ## 
...
`newsTest` with **`MTRY=`50**:  
**Accuracy:** 0.7414  
**Misclassification Rate:** 0.2586
...
```
    ...
    ## Summary of sample sizes: 1517, 1518, 1518, 1517, 1517, 1518, ... 
    ## Resampling results:
    ## 
    ##   Accuracy  Kappa    
    ##   0.751126  0.1789309
...
```
    ...
    ##                  95% CI : (0.7021, 0.7676)
    ##     No Information Rate : 0.7178          
    ##     P-Value [Acc > NIR] : 0.1507          
    ##                                           
    ##                   Kappa : 0.2161          
    ##                                           
    ##  Mcnemar's Test P-Value : 5.317e-16       
    ##                                           
    ##             Sensitivity : 0.25490         
    ##             Specificity : 0.92486         
    ##          Pos Pred Value : 0.57143         
    ##          Neg Pred Value : 0.75949         
    ##              Prevalence : 0.28216         
    ##          Detection Rate : 0.07192         
    ##    Detection Prevalence : 0.12586         
    ##       Balanced Accuracy : 0.58988         
    ##                                           
    ##        'Positive' Class : 0               
    ## 
...
**Random Forests** model predictions on `newsTest` with **`MTRY=`50**:  
**Accuracy:** 0.7414  
**Misclassification Rate:** 0.2586
...
published on a **Saturday** is done using **Ensemble Model with Random
Forests**. This is based on having a higher **accuracy value of 0.7414**
with an associated **misclassification rate of 0.2586**.
