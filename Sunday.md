...
```
    ...
    ## Summary of sample sizes: 1414, 1414, 1413, 1414, 1414, 1413, ... 
    ## Resampling results across tuning parameters:
    ## 
    ##   mtry  Accuracy   Kappa    
    ##    2    0.7193625  0.1981996
    ##    7    0.7160054  0.2108721
    ##   12    0.7151170  0.2147375
    ##   18    0.7122944  0.2151886
    ##   23    0.7126441  0.2168790
    ##   28    0.7119405  0.2154005
    ##   34    0.7085815  0.2080753
    ##   39    0.7061067  0.2030573
    ##   44    0.7092888  0.2131470
    ##   50    0.7041624  0.2018921
    ## 
...
```
    ...
    ##          Neg Pred Value : 0.70178         
    ##              Prevalence : 0.32633         
    ##          Detection Rate : 0.05686         
    ##    Detection Prevalence : 0.09642         
    ##       Balanced Accuracy : 0.55776         
    ##                                           
    ##        'Positive' Class : 0               
    ## 
...
published on a **Sunday** is done using **Ensemble Model with Random
Forests**. This is based on having a higher **accuracy value of 0.691**
with an associated **misclassification rate of 0.309**.
