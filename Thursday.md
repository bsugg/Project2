...
```
    ...
    ## Summary of sample sizes: 2510, 2512, 2512, 2510, 2511, 2511, ... 
    ## Resampling results across tuning parameters:
    ## 
    ##   mtry  Accuracy   Kappa    
    ##    2    0.6472841  0.2944366
    ##    7    0.6428374  0.2855281
    ##   12    0.6449613  0.2897965
    ##   18    0.6426375  0.2851565
    ##   23    0.6416427  0.2831472
    ##   28    0.6414438  0.2827531
    ##   34    0.6423068  0.2845106
    ##   39    0.6395849  0.2790373
    ##   44    0.6405144  0.2809384
    ##   50    0.6433024  0.2865270
    ## 
...
```
    ...
    ##                   Kappa : 0.3186          
    ##                                           
    ##  Mcnemar's Test P-Value : 0.05978         
    ##                                           
    ##             Sensitivity : 0.6437          
    ##             Specificity : 0.6752          
...
published on a **Thursday** is done using **the Ensemble Model with
Random Forests**. This is based on having a higher **accuracy value of
0.6591** with an associated **misclassification rate of 0.3409**.
