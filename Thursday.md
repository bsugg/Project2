...
For the analysis of articles published on **Thursday** there are a total
of 7,175 records sliced as:

  - 5,022 records used in the `newsTrain` data set (69.99%)  
  - 2,153 records used in the `newsTest` data set (30.01%)
...
| ------- | ---------------: | -----------------: | ---------------: | ---------------: |
| Min.    |              3.0 |                0.0 |              0.0 |              0.0 |
| 1st Qu. |              9.0 |              246.0 |              1.0 |              0.0 |
| Median  |             10.0 |              397.0 |              1.0 |              0.0 |
| Mean    |             10.3 |              538.7 |              4.4 |              1.2 |
| 3rd Qu. |             12.0 |              696.0 |              3.0 |              1.0 |
| Max.    |             18.0 |             6159.0 |             99.0 |             74.0 |
...
![](Thursday_files/figure-gfm/histogram-1.png)<!-- -->
...
![](Thursday_files/figure-gfm/boxPlot-1.png)<!-- -->
...
![](Thursday_files/figure-gfm/bar100-1.png)<!-- -->
...
```
    ...
    ## Summary of sample sizes: 3766, 3767, 3767, 3766, 3768, 3766, ... 
    ## Resampling results across tuning parameters:
    ## 
    ##   mtry  Accuracy   Kappa    
    ##    2    0.6472858  0.2944309
    ##    7    0.6446316  0.2891369
    ##   12    0.6417770  0.2834725
    ##   18    0.6409809  0.2818520
    ##   23    0.6368660  0.2736370
    ##   28    0.6383259  0.2765737
    ##   34    0.6362008  0.2723362
    ##   39    0.6356045  0.2711220
    ##   44    0.6362004  0.2723457
    ##   50    0.6348734  0.2696845
    ## 
...
```
    ...
    ## Summary of sample sizes: 4519, 4520, 4519, 4521, 4519, 4520, ... 
    ## Resampling results:
    ## 
    ##   Accuracy   Kappa    
    ##   0.6397439  0.2795424
...
published on a **Thursday** is done using **Ensemble Model with Random
Forests**. This is based on having a higher **accuracy value of 0.6591**
with an associated **misclassification rate of 0.3409**.
