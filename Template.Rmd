...
The approach for the Generalized Linear Model with Logistic Regression was chosen given the non-continuous, binary nature of our outcome of predicting either a 0 or 1 for popularity. The same set of possible predictors will be provided.  
