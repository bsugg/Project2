...
bestModel <- ifelse(conMatrixGLM$overall[1]>conMatrixRF$overall[1],"Generalized Linear Regression of Logistic Regression","Random Forests")
...
This shows the best model for predicting the popularity of articles published on a `r params$day` is the `r bestModel`. This is based on having a higher accuracy value of `r bestModelAcc` with an associated misclassification rate of `r bestModelMR`.
